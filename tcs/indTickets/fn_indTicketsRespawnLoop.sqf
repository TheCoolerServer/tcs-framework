/**
	Description:
		Respawn loop responsible by updating the controls on the top of the screen and respawning the player when the individual tickets respawn template is used.
*/
